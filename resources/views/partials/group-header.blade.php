  ...
  <div class="container max-w-3xl mt-12">
    ...
    <div class="pt-12 divide-y divide-solid divide-sky-light">
      ...
      <p class="flex py-3 item-center">
        ...
        <a href="tel:{{ str_replace(' ', '', $contact_details->phone) }}">Phone: {{ $contact_details->phone }}</a>
      </p>
      @endif
      ...
      <p class="flex py-3 item-center">
        ...
        <a target="_blank" href="{{ $contact_details->website }}">Website: {{ $contact_details->website }}</a>
      </p>
      @endif
      ...
      <p class="flex py-3 item-center">
        ...
        <a target="_blank" href="https://facebook.com/{{ str_replace('@', '', $contact_details->facebook) }}">Facebook:
          {{
