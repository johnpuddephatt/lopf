<aside class="hidden pt-24 pb-12 border-r lg:block">
    <nav class="">
        ...
        <a href="{{ get_permalink($project->ID) }}"
            class="px-8 hover:bg-sky-lightest block py-3 text-lg @if(get_permalink() == get_permalink($project->ID) || $project->ID == wp_get_post_parent_id($post)) bg-sky text-blue @else text-gray-600 @endif">
