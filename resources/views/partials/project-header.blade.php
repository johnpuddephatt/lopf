<div>
  <div class="container mt-16 md:mt-12 xl:max-w-5xl">
    ...
    <div
      class="transform transform-gpu ml-auto w-3/4 md:w-80 overlay @if(isset($parent)) md:-mb-24 @else md:-mb-12 @endif"
    >
      {!! get_the_post_thumbnail(isset($post->ID) ? $post->ID : '', 'square-s',
      ['class' => "clip-teardrop w-full md:w-full"]) !!}
    </div>
    @endif
    ...
    <div class="">
      ...
      <p
        class="max-w-xl mt-8 text-xl font-bold leading-snug tracking-tight md:text-2xl"
      >
        {!! $post->post_excerpt !!}
      </p>
      @endif
