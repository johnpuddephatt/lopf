<a href="{{ get_permalink($page->ID) }}" @php(post_class('flex flex-row space-x-16'))>
    <div
        class="w-48 flex-0 relative {{ match($key % 4) { 0 => 'circle-orange', 1 => 'circle-blue', 2 => 'circle-sky', 3 => 'circle-pink'} }}">
        ...
        {!! get_the_post_thumbnail($page->ID, 'square-xs', ['class' => "w-48 clip-teardrop max-w-none block "])
        !!}
        @else
